...
SampleTable:
	...
	dcSample	TYPE_DPCM,	ClintonHi,	20600,	FLAGS_SFX	; $C7
	dcSample	TYPE_DPCM,	ClintonYeah,	20600,	FLAGS_SFX	; $C8
	dcSample	TYPE_PCM,	QuakeJump,	0,	FLAGS_SFX		; $C9
	dcSample	TYPE_PCM_TURBO,	SegaPCM,	0,	FLAGS_SFX	; $CA
	dcSample	TYPE_PCM,	letsgoeee,	0,	FLAGS_SFX		; $CB
	dcSample	TYPE_PCM,	Lg,		16000, FLAGS_SFX		; $CC
	dcSample	TYPE_PCM,	Segay,		0, FLAGS_SFX		; $CD
	dcSample	TYPE_PCM,	Foxy,		0, FLAGS_SFX		; $CE
	dcSample	TYPE_PCM,	GayNeil,	0, FLAGS_SFX		; $CF
	dcSample	TYPE_DPCM,	funnyb_utthole,	8000, FLAGS_SFX	; $D0
