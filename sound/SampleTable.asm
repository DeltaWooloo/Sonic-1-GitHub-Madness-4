...
; Song related samples (like kicks, snares, toms, timpanis, etc...)
	...
	dcSample	TYPE_PCM,	Github, 16000,FLAGS_SFX			; $9F
	dcSample	TYPE_PCM,	Madness, 16000,FLAGS_SFX		; $A0
	dcSample	TYPE_PCM,	MadnessR, 16000,FLAGS_SFX		; $A1

	dcSample	TYPE_PCM,	QuakeRocket,	11297,			; $A2
	dcSample	TYPE_PCM,	supbeaches,	11297,				; $A3
	dcSample	TYPE_PCM,	CL_Penis,	11297,				; $A4
	dcSample	TYPE_PCM,	CL_STFU,	11297,FLAGS_SFX		; $A5
	dcSample	TYPE_PCM,	CL_Fuck,	11297,				; $A6
	dcSample	TYPE_PCM,	CL_YouCanSuck,	11297,FLAGS_SFX	; $A7
	dcSample	TYPE_PCM,	CL_DoYouSuck,	11297,FLAGS_SFX	; $A8
	dcSample	TYPE_PCM,	CL_Dicks,	11297,				; $A9
	dcSample	TYPE_PCM,	CL_OnTheBall,	11297,			; $AA
	dcSample	TYPE_PCM,	Penises,	11297,				; $AB
	dcSample	TYPE_PCM,	EggNo,		11297,				; $AC
	dcSample	TYPE_PCM,	BabyAlarm,	0,FLAGS_SFX 		; $AD
	; Level end theme
	dcSample	TYPE_DPCM,	BoingBoing,	16000,FLAGS_LOOP 	; $AE
	dcSample	TYPE_PCM,	Boik,	0,FLAGS_SFX 			; $AF
	dcSample	TYPE_PCM,	Boioing,	0,FLAGS_SFX 		; $B0
	dcSample	TYPE_PCM,	OrngLaugh,	0,FLAGS_SFX 		; $B1

	dcSample	TYPE_DPCM,	ClintonHi,	20600,FLAGS_SFX 	; $B2
	dcSample	TYPE_DPCM,	ClintonYeah,	20600,FLAGS_SFX ; $B3
	; Keep this as the last sample pls (and make sure to add a sample constant to _smps2asm.asm
	dcSample	TYPE_PCM,	QuakeJump,	0, FLAGS_SFX 		; $B4
	dcSample	TYPE_PCM_TURBO,	SegaPCM,	0, FLAGS_SFX	; $B5
	dc.w	-1	; end marker
