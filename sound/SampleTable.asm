...
SampleTable:
	...
	dcSample	TYPE_PCM,	CL_STFU,	11297,FLAGS_SFX	; $B2
	dcSample	TYPE_PCM,	CL_Fuck,	11297,		; $B3
	...
	dcSample	TYPE_PCM,	Boik,		7125,	FLAGS_SFX	; $BC
	dcSample	TYPE_PCM,	Boioing,	7125,	FLAGS_SFX	; $BD
