...
; Song related samples (like kicks, snares, toms, timpanis, etc...)
	...
	dcSample	TYPE_PCM,	QuakeRocket,	11297,			; $9E
	dcSample	TYPE_PCM,	supbeaches,	11297,			; $9F
	dcSample	TYPE_PCM,	CL_Penis,	11297,			; $A0
	dcSample	TYPE_PCM,	CL_STFU,	11297,FLAGS_SFX		; $A1
	dcSample	TYPE_PCM,	CL_Fuck,	11297,			; $A2
	dcSample	TYPE_PCM,	CL_YouCanSuck,	11297,FLAGS_SFX		; $A3
	dcSample	TYPE_PCM,	CL_DoYouSuck,	11297,FLAGS_SFX		; $A4
	dcSample	TYPE_PCM,	CL_Dicks,	11297,			; $A5
	dcSample	TYPE_PCM,	CL_OnTheBall,	11297,			; $A6
	dcSample	TYPE_PCM,	Penises,	11297,			; $A7
	dcSample	TYPE_PCM,	EggNo,		11297,			; $A8
