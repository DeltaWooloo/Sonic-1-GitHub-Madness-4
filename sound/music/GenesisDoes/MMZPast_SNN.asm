MMZPast_Sonineko_Header:
	smpsHeaderStartSong 1
	smpsHeaderVoice     MMZPast_Sonineko_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $03

	smpsHeaderDAC       MMZPast_Sonineko_DAC
	smpsHeaderFM        MMZPast_Sonineko_FM1,	$00, $10
	smpsHeaderFM        MMZPast_Sonineko_FM2,	$00, $10
	smpsHeaderFM        MMZPast_Sonineko_FM3,	$00, $10
	smpsHeaderFM        MMZPast_Sonineko_FM4,	$00, $10
	smpsHeaderFM        MMZPast_Sonineko_FM5,	$00, $1A
	smpsHeaderPSG       MMZPast_Sonineko_PSG1,	$DC, $02, $00, $00
	smpsHeaderPSG       MMZPast_Sonineko_PSG2,	$DC, $02, $00, $00
	smpsHeaderPSG       MMZPast_Sonineko_PSG3,	$23, $00, $00, $00

; FM1 Data
MMZPast_Sonineko_FM1:
	dc.b	nRst, $40, $40
	smpsSetvoice        $01

MMZPast_Sonineko_Loop1C:
	dc.b	nD3, $04, nF3, nD3, nC3, nA2, nG2, nF2, nD2
	smpsLoop            $00, $20, MMZPast_Sonineko_Loop1C

MMZPast_Sonineko_Loop1D:
	smpsSetvoice        $03
	...
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop1D
	smpsJump            MMZPast_Sonineko_FM1

; FM2 Data
MMZPast_Sonineko_FM2:
	dc.b	nRst, $40
	smpsPan             panCenter, $00
	smpsSetvoice        $03

MMZPast_Sonineko_Loop12:
	dc.b	nA4, $02, nRst, $04, nAb4, $02, nRst, $04, nG4, $02, nRst, $06
	dc.b	nF4, $02, nRst, nD4, nRst, $06
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop12
	dc.b	nD4, $19, nRst, $6B
	smpsPan             panLeft, $00
	smpsSetvoice        $00
...
MMZPast_Sonineko_Loop13:
	dc.b	nAb4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop13
	dc.b	nD4, $02, nRst, $04, nAb4, $02, nRst, $06, nA4, $02, nRst, $04
	dc.b	nD5, $02, nRst, $04, nA4, $02, nRst, $04, nB4, $02, nRst, $04
	dc.b	nA4, $02, nRst, $06

MMZPast_Sonineko_Loop14:
	dc.b	nAb4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop14
...
MMZPast_Sonineko_Loop15:
	dc.b	nAb4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop15
	dc.b	nD4, $02, nRst, $04, nAb4, $02, nRst, $06, nA4, $02, nRst, $04
	dc.b	nD5, $02, nRst, $04, nA4, $02, nRst, $04, nB4, $02, nRst, $04
	dc.b	nA4, $02, nRst, $06

MMZPast_Sonineko_Loop16:
	dc.b	nAb4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop16
	dc.b	nD4, $02, nRst, $04, nAb4, $02, nRst
	smpsPan             panCenter, $00
	smpsSetvoice        $04
...
MMZPast_Sonineko_Loop17:
	dc.b	nAb3, nG3, nF3, nD3, nC3, nG3
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop17
	dc.b	nAb3, nG3, nF3, nD3, nC3, nD3, $04, nF3, $02, nG3, $04, nAb3
	dc.b	$02, nA3, nC4, nCs4, nD4, nF4, nG4
	smpsSetvoice        $03
	dc.b	nA4

MMZPast_Sonineko_Loop18:
	dc.b	nRst, $04, nAb4, $02, nRst, $04, nG4, $02, nRst, $06, nF4, $02
	dc.b	nRst, nD4, nRst, $06, nA4, $02
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop18
	dc.b	nRst, $04, nAb4, $02, nRst, $04, nG4, $02, nRst, $06, nF4, $02
	dc.b	nRst, nD4, nRst, $06, nD4, $04
	smpsPan             panLeft, $00
	smpsSetvoice        $00

MMZPast_Sonineko_Loop1A:
	dc.b	nA4, $02, nRst, $04, nD5, $02, nRst, $04, nA4, $02, nRst, $04
	dc.b	nB4, $02, nRst, $04, nA4, $02, nRst, $06

MMZPast_Sonineko_Loop19:
	dc.b	nAb4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop19
	dc.b	nD4, $02, nRst, $04, nAb4, $02, nRst, $06
	smpsLoop            $01, $03, MMZPast_Sonineko_Loop1A
	dc.b	nA4, $02, nRst, $04, nD5, $02, nRst, $04, nA4, $02, nRst, $04
	dc.b	nB4, $02, nRst, $04, nA4, $02, nRst, $06

MMZPast_Sonineko_Loop1B:
	dc.b	nAb4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop1B
	...
	smpsSetvoice        $02
	dc.b	nE4, nG4, nE4, nD4, nE4, $06, $02, nRst, nE4, nG4, $04
	smpsJump            MMZPast_Sonineko_FM2

; FM3 Data
MMZPast_Sonineko_FM3:
	dc.b	nRst, $40, $40, $40, $44
	smpsPan             panRight, $00
	smpsSetvoice        $00

MMZPast_Sonineko_Loop0D:
	dc.b	nF4, $02, nRst, $04, nBb4, $02, nRst, $04, nF4, $02, nRst, $04
	dc.b	nG4, $02, nRst, $04, nF4, $02, nRst, $06

MMZPast_Sonineko_Loop0C:
	dc.b	nF4, $02, nRst, $04
	smpsLoop            $00, $04, MMZPast_Sonineko_Loop0C
	dc.b	nF4, $02, nRst, $06
	smpsLoop            $01, $03, MMZPast_Sonineko_Loop0D
	dc.b	nF4, $02, nRst, $04, nBb4, $02, nRst, $04, nF4, $02, nRst, $04
	dc.b	nG4, $02, nRst, $04, nF4, $02, nRst, $06

MMZPast_Sonineko_Loop0E:
	dc.b	nF4, $02, nRst, $04
	smpsLoop            $00, $04, MMZPast_Sonineko_Loop0E
	dc.b	nF4, $02, nRst, nRst, $40, $40
	smpsPan             panCenter, $00
	smpsSetvoice        $03
	dc.b	nD4, $19, nRst, $67, $40, $44
	smpsPan             panRight, $00
	smpsSetvoice        $00

MMZPast_Sonineko_Loop10:
	dc.b	nF4, $02, nRst, $04, nBb4, $02, nRst, $04, nF4, $02, nRst, $04
	dc.b	nG4, $02, nRst, $04, nF4, $02, nRst, $06

MMZPast_Sonineko_Loop0F:
	dc.b	nF4, $02, nRst, $04
	smpsLoop            $00, $04, MMZPast_Sonineko_Loop0F
	dc.b	nF4, $02, nRst, $06
	smpsLoop            $01, $03, MMZPast_Sonineko_Loop10
	dc.b	nF4, $02, nRst, $04, nBb4, $02, nRst, $04, nF4, $02, nRst, $04
	dc.b	nG4, $02, nRst, $04, nF4, $02, nRst, $06

MMZPast_Sonineko_Loop11:
	dc.b	nF4, $02, nRst, $04
	smpsLoop            $00, $04, MMZPast_Sonineko_Loop11
	...
	smpsSetvoice        $02
	dc.b	nA3, nC4, nA3, nG3, nA3, $06, $02, nRst, nA3, nC4, $04
	smpsJump            MMZPast_Sonineko_FM3

; FM4 Data
MMZPast_Sonineko_FM4:
	dc.b	nRst, $40, $40, $40, $44
	smpsSetvoice        $00

MMZPast_Sonineko_Loop07:
	dc.b	nD4, $02, nRst, $04, nG4, $02, nRst, $04, nD4, $02, nRst, $04
	dc.b	nE4, $02, nRst, $04, nD4, $02, nRst, $06

MMZPast_Sonineko_Loop06:
	dc.b	nD4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop06
	dc.b	nAb4, $02, nRst, $04, nD4, $02, nRst, $06
	smpsLoop            $01, $03, MMZPast_Sonineko_Loop07
	dc.b	nD4, $02, nRst, $04, nG4, $02, nRst, $04, nD4, $02, nRst, $04
	dc.b	nE4, $02, nRst, $04, nD4, $02, nRst, $06

MMZPast_Sonineko_Loop08:
	dc.b	nD4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop08
	dc.b	nAb4, $02, nRst, $04, nD4, $02, nRst, nRst, $40, $40, $40, $40
	dc.b	$40, $44

MMZPast_Sonineko_Loop0A:
	dc.b	nD4, $02, nRst, $04, nG4, $02, nRst, $04, nD4, $02, nRst, $04
	dc.b	nE4, $02, nRst, $04, nD4, $02, nRst, $06

MMZPast_Sonineko_Loop09:
	dc.b	nD4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop09
	dc.b	nAb4, $02, nRst, $04, nD4, $02, nRst, $06
	smpsLoop            $01, $03, MMZPast_Sonineko_Loop0A
	dc.b	nD4, $02, nRst, $04, nG4, $02, nRst, $04, nD4, $02, nRst, $04
	dc.b	nE4, $02, nRst, $04, nD4, $02, nRst, $06

MMZPast_Sonineko_Loop0B:
	dc.b	nD4, $02, nRst, $04
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop0B
	...
	smpsJump            MMZPast_Sonineko_FM4

; FM5 Data
MMZPast_Sonineko_FM5:
	dc.b	nRst, $46
	smpsSetvoice        $03

MMZPast_Sonineko_Loop03:
	dc.b	nA4, $02, nRst, $04, nAb4, $02, nRst, $04, nG4, $02, nRst, $06
	dc.b	nF4, $02, nRst, nD4, nRst, $06
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop03
	dc.b	nD4, $19, nRst, $61, $40, $40, $06, nD4, $19, nRst, $65
	smpsSetvoice        $04
...
MMZPast_Sonineko_Loop04:
	dc.b	nAb3, nG3, nF3, nD3, nC3, nG3
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop04
	dc.b	nAb3, nG3, nF3, nD3, nC3, nD3, $04, nF3, $02, nG3, $04, nAb3
	dc.b	$02, nA3, nC4, nCs4, nD4, nF4, nG4, nRst
	smpsSetvoice        $03
	dc.b	nA4

MMZPast_Sonineko_Loop05:
	dc.b	nRst, $04, nAb4, $02, nRst, $04, nG4, $02, nRst, $06, nF4, $02
	dc.b	nRst, nD4, nRst, $06, nA4, $02
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop05
	dc.b	nRst, $04, nAb4, $02, nRst, $04, nG4, $02, nRst, $06, nF4, $02
	dc.b	nRst, nD4, nRst, $06, nD4, $19, nRst, $61, $40, $40, $06, nD3
	dc.b	$02, nRst, nC3, nRst, nD3, nRst, $0A, nC3, $02, nRst, nD3, nRst
	dc.b	$26, nA2, $02, nRst, nG2, nRst, nA2, nRst, $0A, nG2, $02, nRst
	dc.b	nA2, nRst, $26, nD3, $02, nRst, nC3, nRst, nD3, nRst, $0A, nC3
	dc.b	$02, nRst, nD3, nRst, $26, nA2, $02, nRst, nG2, nRst, nA2, nRst
	dc.b	$0A, nG2, $02, nRst, nA2, nRst, $20
	smpsJump            MMZPast_Sonineko_FM5

; PSG1 Data
MMZPast_Sonineko_PSG1:
	smpsPSGvoice        fTone_04

MMZPast_Sonineko_Loop25:
	...
	smpsLoop            $00, $12, MMZPast_Sonineko_Loop25
	dc.b	nRst, $40, $40, $40, $40
	smpsJump            MMZPast_Sonineko_PSG1

; PSG2 Data
MMZPast_Sonineko_PSG2:
	smpsPSGvoice        fTone_04

MMZPast_Sonineko_Loop24:
	...
	smpsLoop            $00, $12, MMZPast_Sonineko_Loop24
	dc.b	nRst, $40, $40, $40, $40
	smpsJump            MMZPast_Sonineko_PSG2

; PSG3 Data
MMZPast_Sonineko_PSG3:
	smpsPSGform         $E7

MMZPast_Sonineko_Jump00:
	dc.b	nRst, $40
	smpsPSGvoice        fTone_02
	dc.b	nAb6

MMZPast_Sonineko_Loop1E:
	dc.b	$08
	smpsLoop            $00, $07, MMZPast_Sonineko_Loop1E
	dc.b	$02, $02, $02, $02, $02, nRst, nAb6, nAb6

MMZPast_Sonineko_Loop21:
	dc.b	nAb6, nRst, nAb6, nAb6, nAb6, nAb6, nRst, nAb6, nAb6, nRst

MMZPast_Sonineko_Loop1F:
	dc.b	nAb6, nAb6

MMZPast_Sonineko_Loop20:
	dc.b	nAb6, nRst, nAb6, nAb6
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop1F
	smpsLoop            $01, $02, MMZPast_Sonineko_Loop20
	smpsLoop            $02, $10, MMZPast_Sonineko_Loop21

MMZPast_Sonineko_Loop22:
	dc.b	nAb6, nRst, nAb6
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop22
	dc.b	nRst, nAb6, nAb6, nAb6, nRst, nAb6, nAb6
	smpsLoop            $01, $07, MMZPast_Sonineko_Loop22

MMZPast_Sonineko_Loop23:
	dc.b	nAb6, nRst, nAb6
	smpsLoop            $00, $03, MMZPast_Sonineko_Loop23
	dc.b	nRst, nAb6, nAb6
	smpsJump            MMZPast_Sonineko_Jump00

; DAC Data
MMZPast_Sonineko_DAC:
...
MMZPast_Sonineko_Loop00:
	dc.b	$02
	smpsLoop            $00, $10, MMZPast_Sonineko_Loop00
...
MMZPast_Sonineko_Loop02:
	...
	smpsLoop            $00, $02, MMZPast_Sonineko_Loop02
	smpsJump            MMZPast_Sonineko_DAC

MMZPast_Sonineko_Voices:
;	Voice $00
;	$3A
...
;	$09, $00, $00, $00, 	$71, $83, $14, $05, 	$14, $23, $1E, $7F
	...
	smpsFooterEndSong	"GenesisDoes/MMZPast_SNN.asm"
	even
