...
Mus8C_Boss_Loop01:
	dc.b	nFs7, $03, nD7
	smpsLoop	0, 8, Mus8C_Boss_Loop01
...
Mus8C_Boss_Jump02:
	dc.b	nFs4, $06, nFs5
	smpsLoop 	0, 4, Mus8C_Boss_Jump02
...
; DAC Data
Mus8C_Boss_DAC:
	dc.b	dHiTimpani, $06, dLowTimpani
	smpsLoop	0, 4, Mus8C_Boss_DAC

Mus8C_Boss_Loop00:
	smpsCall	BGM_Final_DAC_Call
	dc.b	$12, $06, $0C, $0C
	smpsLoop	0, 3, Mus8C_Boss_Loop00
	smpsCall	BGM_Final_DAC_Call
	dc.b	$06, $0C, $06, $06, $0C, $06

Mus8C_Boss_Loop02:
	dc.b	dHiTimpani, $06, dLowTimpani
	smpsLoop	0, 4, Mus8C_Boss_Loop02
	smpsJump	Mus8C_Boss_DAC

BGM_Final_DAC_Call:
	dc.b	dProtoSnare, $0C, $04, $04, $04, $06, $0C, $06
	smpsReturn
