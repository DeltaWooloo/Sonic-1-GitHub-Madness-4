BGM_RonicSetro_Header:
	...
	smpsHeaderFM        BGM_RonicSetro_FM2,	$00, $01
	smpsHeaderPSG       BGM_RonicSetro_PSG1,	$0C, $01, $00, $00
	smpsHeaderPSG       BGM_RonicSetro_PSG2,	$0C, $00, $00, $00
	smpsHeaderPSG       BGM_RonicSetro_PSG3,	$00, $01, $00, fTone_02
...
BGM_RonicSetro_Loop00:
	dc.b	dSnare, $0C, dKick
	smpsLoop            $00, $04, BGM_RonicSetro_Loop00
	dc.b	dSnare

BGM_RonicSetro_Loop01:
	dc.b	dKick, $06, $06, dSnare, dKick, $03, dSnare, $06, $06, dKick, $03, dSnare
	dc.b	$09, $03
	smpsLoop            $00, $04, BGM_RonicSetro_Loop01
	dc.b	dKick, $06, $06, dSnare, dKick, $03, dSnare, $06, $06, dKick, $03, dSnare
	dc.b	$09

BGM_RonicSetro_Loop02:
	dc.b	$78, nRst
	smpsLoop            $00, $04, BGM_RonicSetro_Loop02
	smpsSetTempoMod $01
	dc.b	nRst, nRst, $03
	smpsPan             panCenter, $00
	smpsStop
...
BGM_RonicSetro_Loop03:
	dc.b	$56
	smpsLoop            $00, $0C, BGM_RonicSetro_Loop03
	smpsPan             panCenter, $00
	smpsSetvoice        $00
	smpsStop
...
BGM_RonicSetro_Loop07:
	dc.b	nC2, $02, nC3, $01, nRst, $03
	smpsLoop            $00, $02, BGM_RonicSetro_Loop07
	dc.b	nB1, $02, nB2, $01, nB1, $02, $01, nB2, $02, nB1, $01, nC2
	dc.b	$02, nC3, $01, nRst, $18

BGM_RonicSetro_Loop08:
	dc.b	nC2, $02, nC3, $01, nRst, $03
	smpsLoop            $00, $02, BGM_RonicSetro_Loop08
	dc.b	nD2, $02, nD3, $01, nD2, $02, $01, nD3, $02, nD2, $01, nC2
	dc.b	$02, nC3, $01, nRst, $18

BGM_RonicSetro_Loop09:
	dc.b	nC2, $02, nC3, $01, nRst, $03
	smpsLoop            $00, $02, BGM_RonicSetro_Loop09
	dc.b	nB1, $02, nB2, $01, nB1, $02, $01, nB2, $02, nB1, $01, nC2
...
BGM_RonicSetro_Loop0A:
	dc.b	nC2, $02, nC3, $01, nRst, $03
	smpsLoop            $00, $02, BGM_RonicSetro_Loop0A
	dc.b	nB1, $02, nB2, $01, nB1, $02, $01, nB2, $02, nB1, $01, nC2
	dc.b	$02, nC3, $01, nRst, $18

BGM_RonicSetro_Loop0B:
	dc.b	nC2, $02, nC3, $01, nRst, $03
	smpsLoop            $00, $02, BGM_RonicSetro_Loop0B
	dc.b	nD2, $02, nD3, $01, nD2, $02, $01, nD3, $02, nD2, $01, nC2
	dc.b	$02, nC3, $01, nRst, $0C, nF2

BGM_RonicSetro_Loop0C:
	dc.b	$02, nF3, $01, nF2, $02, $01
	smpsLoop            $00, $03, BGM_RonicSetro_Loop0C
	dc.b	nRst, $0C, nF2, $02, nF3, $01, nF2, $02, $01, nRst, $06, nE2
	dc.b	$02, nE3, $01, nE2, $02, $01, nRst, $18, nC2

BGM_RonicSetro_Loop0D:
	dc.b	$02, nC3, $01, nC2, $02, $01, nC3, $02, nC2, $01
	smpsLoop            $00, $02, BGM_RonicSetro_Loop0D
	dc.b	$02, nC3, $01, nC2, $02, $01, nRst

BGM_RonicSetro_Loop0E:
	dc.b	$56
	smpsLoop            $00, $0C, BGM_RonicSetro_Loop0E
	smpsPSGvoice        $00
	smpsStop
...
BGM_RonicSetro_PSG3:
	smpsPSGform         $E7
	smpsPSGAlterVol     $02
	dc.b	nMaxPSG1, $03, $03, $03, $03, $0C

BGM_RonicSetro_Loop04:
	dc.b	$06
	smpsLoop            $00, $10, BGM_RonicSetro_Loop04

BGM_RonicSetro_Loop05:
	dc.b	$03
	smpsLoop            $00, $4F, BGM_RonicSetro_Loop05

BGM_RonicSetro_Loop06:
	dc.b	$78, smpsNoAttack
	smpsLoop            $00, $08, BGM_RonicSetro_Loop06
	dc.b	$7B
	smpsStop
...
;	$00, $01, $03, $00, 	$16, $17, $16, $A6, 	$25, $2F, $25, $00
	...
	smpsFooterEndSong	"Pikanoob/Mus - Ronic Setro.asm"