SndC4_Bomb_Header:
	...
	smpsHeaderSFXChannel cFM4, SndC4_Bomb_FM4,		$00, $00
	smpsHeaderSFXChannel cPSG3, SndC4_Bomb_PSG3,	$00, $02
...
SndC4_Bomb_Loop01:
	dc.b	nFs1, $08
	smpsAlterVol        $04
	smpsLoop            $00, $0C, SndC4_Bomb_Loop01
	smpsStop
...
SndC4_Bomb_Loop00:
	dc.b	nE1, $0A
	smpsAlterVol        $04
	smpsLoop            $00, $0C, SndC4_Bomb_Loop00
	smpsStop
...
SndC4_Bomb_Loop02:
	...
	smpsPSGAlterVol     $00
	smpsLoop            $00, $09, SndC4_Bomb_Loop02

SndC4_Bomb_Loop03:
	dc.b	nAb5, $0B, smpsNoAttack
	smpsPSGAlterVol     $01
	smpsLoop            $00, $03, SndC4_Bomb_Loop03
	smpsStop
