...
SSRGScreen_Loop:
		...
		andi.b	#btnB+btnStart,(v_jpadpress1).w 			; is Start button pressed on any controller?
...
SSRGScreen_Finish:
		...
		;move.b	#id_EagleSoft,(v_gamemode).w			; set the screen mode to EagleSoft
		rts						; return
...
SRG_DFG_DrawFlash:		
		...
		bsr.w	MapScreenAdd				; write to the map plane
		;!@ Play button sfx
...
; Pal_SSRG:	dc.w	$0000,$0400,$0800,$0C00,$0E00,$0EEE,$0AAA,$0888
		...
		; dc.w	$0000,$0000,$0000,$0000,$0000,$0000,$0000,$0000
Pal_SSRG:	binclude		"SSRG.pal"
		even
; ---------------------------------------------------------------------------
ArtMain_SSRG:	binclude	"ArtMain.nem"
		even
ArtSquare_SSRG:	binclude	"ArtSquare.nem"
		even
ArtSonic_SSRG:	binclude	"ArtSonic.nem"
		even
ArtLink_SSRG:	binclude	"ArtLink.nem"
		even
; ---------------------------------------------------------------------------
MapMain_SSRG:	binclude	"MapMain.kos"
		even
MapSquare_SSRG:	binclude	"MapSquare.kos"
		even
MapLink_SSRG:	binclude	"MapLink.kos"
		even
;!@
MapLink2_SSRG:	binclude	"MapLink2.kos"
		even		
; ---------------------------------------------------------------------------
; ===========================================================================