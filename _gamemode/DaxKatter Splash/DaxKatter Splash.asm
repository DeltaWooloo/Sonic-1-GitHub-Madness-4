...
; ---------------------------------------------------------------------------
	...
	include	"_gamemode/DaxKatter Splash/Dax_Macros.asm"
...
Map_DaxKatterD:
	include		"_gamemode/DaxKatter Splash/Maps/Map - DaxKatter Splash.asm"
	even

EniMap_DaxKatterText:
	binclude	"_gamemode/DaxKatter Splash/Maps/Map - DaxKatter Mappings.eni"
	even

EniMap_BringsYou:
	binclude	"_gamemode/DaxKatter Splash/Maps/Map - Brings You Mappings.eni"
	even

; ---------------------------------------------------------------------------

Pal_DaxKatterOff:
	binclude	"_gamemode/DaxKatter Splash/Pal/Pal - Init.bin"
	even

Pal_DaxKatterOn:
	binclude	"_gamemode/DaxKatter Splash/Pal/Pal - After Flash.bin"
	even

Pal_DaxKatterBringsYou:
	binclude	"_gamemode/DaxKatter Splash/Pal/Pal - Brings You.bin"
	even

; ---------------------------------------------------------------------------

ArtNem_DaxKatter_D:
	binclude	"_gamemode/DaxKatter Splash/Art/DaxKatter Splash - D.nem"
	even

ArtNem_DaxKatter_Text:
	binclude	"_gamemode/DaxKatter Splash/Art/DaxKatter Splash - Text.nem"
	even
