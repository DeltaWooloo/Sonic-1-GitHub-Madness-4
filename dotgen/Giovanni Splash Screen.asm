; ================================================================
; "GIOVANNI.GEN" Splash Screen
; Programmed by giovanni.gen
; Artwork by giovanni.gen and Cinossu
; Code based on Static Splash Screen for Sonic 1 by Hixatas and
; ProjectFM
; ================================================================
...
GiovanniSplash:
	...
	lea	(v_palette).l,a1        		; get beginning of palette line
...
Giovanni_DeformLoop:
	...
	move.l	#$4FC00003,4(a6)
	move.w	#$F,d1
	
.blanktile:
	move.w	#0,(a6)
	dbf	d1,.blanktile
	lea	(Art_MenuFont).l,a5			; fetch the text graphics
...
.looptext
	...
	move.l	#v_palette+$20,(p_awreplace).w
...
; ===============================================================
; Subroutine that deforms the screen until all of its lines are
; properly centered
; ===============================================================
