...
; ---------------------------------------------------------------------------
; !@ GD: Standard callback for enemies
; ---------------------------------------------------------------------------
stdEn_callback:
	move.l	a0,a1							; Move a0 (this object) into a1
	lea		(v_player).w,a0					; Move player into a0
	jmp		(React_Enemy.donthurtsonic).l	; Do the hit callback
