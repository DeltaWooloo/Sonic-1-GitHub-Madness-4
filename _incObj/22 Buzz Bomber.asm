...
; time to move, missile delay, time to shoot, amount to shoot, movement speed
			...
			dc.w	$007F,	$0004,	$0010,	$0001,	$0400,  $0000, $0000,  $0000		; NO-GAY-LES - DOES NOT APPEAR, SHOULD BE IN VRAM
			dc.w	$007F,	$003B,	$0010,	$0001,	$0400,  $0000, $0000,  $0000		; BSZ - DOES NOT APPEAR, SHOULD BE IN VRAM
			dc.w	$007F,	$003B,	$0010,	$0001,	$0400,  $0000, $0000,  $0000		; BTZ/Old John - DOES NOT APPEAR, SHOULD BE IN VRAM
			dc.w	$007F,	$003B,	$0010,	$0001,	$0400,  $0000, $0000,  $0000		; ARZ - DOES NOT APPEAR, SHOULD BE IN VRAM
