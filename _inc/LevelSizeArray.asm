...
; ---------------------------------------------------------------------------
		...
		dc.w CAMDR_ABC, $0000, $0540, $0000, $0300, $0060
		; SLZ
		...
		dc.w CAMDR_ABC, $0000, $24BF, $0000, $0300, $0060
		dc.w CAMDR_ABC, $0000, $1EBF, $0000, $0300, $0060
		dc.w CAMDR_ABC, $0000, $2960, $0000, $0520, $0060		
		dc.w CAMDR_ABC, $0000, $0100, $0000, $0000, $0060
		; x WIN
		dc.w CAMDR_ABC, $0000, $20C0, $0000, $0420, $0060
		dc.w CAMDR_ABC, $0000, $1FBF, $0000, $0320, $0060
		dc.w CAMDR_ABC, $0000, $2000, $0000, $06C0, $0060
		dc.w CAMDR_ABC, $0000, $3EC0, $0000, $0720, $0060
		even
		; x Joint
		...
		dc.w CAMDR_ABC, $0000, $0D40, $0000, $0590, $0060
		...
		; BSZ
		dc.w CAMDR_ABC, $0000, $21C0, $0000, $0720, $0060
		dc.w CAMDR_ABC, $0000, $1E40, $0000, $0520, $0060
