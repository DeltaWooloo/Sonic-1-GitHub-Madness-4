...
;!@ Toggle between Kos-compressed and Nem-compressed 8x8 level tile graphics depending on M2Engage flag
 ...
 if M2Engage=0
	...
	lhead	plcid_LZ,Kos_LZ,plcid_LZ2,Blk16_LZ,Blk256_LZ,bgm_BeforeBoss,palid_LZ,Col_LZ,ObjPos_LZ2, Level_LZ2,Level_LZbg
	lhead	plcid_LZ,Kos_LZ,plcid_LZ2,Blk16_LZ,Blk256_LZ,bgm_WarioLand1Boss,palid_LZ,Col_LZ,ObjPos_LZ3, Level_LZ3,Level_LZbg
	...
	lhead	plcid_SLZ,Kos_SLZ,plcid_SLZ2,Blk16_SLZ,Blk256_SLZ,bgm_BeforeBoss,palid_SLZ,Col_SLZ,ObjPos_Null,Level_SLZ1,Level_SLZbg
	...
	lhead	plcid_SYZ,Kos_SYZ,plcid_SYZ2,Blk16_SYZ,Blk256_SYZ,bgm_BeforeBoss,palid_SYZ,Col_SYZ,ObjPos_Null,Level_SYZ1,Level_SYZbg
	...
	lhead	plcid_WIN,Kos_WIN,plcid_WIN2,Blk16_WIN,Blk256_WIN,bgm_BeforeBoss,palid_WIN,Col_WIN,ObjPos_WIN1,Level_WIN1,Level_WINbg

	lhead	plcid_Joint,Kos_Joint,plcid_Joint2,Blk16_Joint,Blk256_Joint,bgm_Title,palid_Joint,Col_Joint,ObjPos_Joint1,Level_Joint1,Level_Jointbg
	lhead	plcid_Joint,Kos_Joint,plcid_Joint2,Blk16_Joint,Blk256_Joint,bgm_Title,palid_Joint,Col_Joint,ObjPos_Joint2,Level_Joint2,Level_Jointbg
	lhead	plcid_Joint,Kos_Joint,plcid_Joint2,Blk16_Joint,Blk256_Joint,bgm_Title,palid_Joint,Col_Joint,ObjPos_Joint3,Level_Joint3,Level_Jointbg
	lhead	plcid_Joint,Kos_Joint,plcid_Joint2,Blk16_Joint,Blk256_Joint,bgm_Title,palid_Joint,Col_Joint,ObjPos_Joint1,Level_Joint1,Level_Jointbg

	lhead	plcid_DVZ,Kos_DVZ,plcid_DVZ2,Blk16_DVZ,Blk256_DVZ,bgm_DoleDetective,palid_DVZ,Col_DVZ,ObjPos_DVZ1,Level_DVZ1,Level_DVZbg
	lhead	plcid_DVZ,Kos_HSZ,plcid_DVZ2,Blk16_HSZ,Blk256_HSZ,bgm_HardwareStore,palid_HARDWARE,Col_HSZ,ObjPos_HSZ,Level_HSZ,Level_HSZbg
	lhead	plcid_DVZ,Kos_DVZ3,plcid_DVZ2,Blk16_DVZ3,Blk256_DVZ3,bgm_BeforeBoss,palid_DVZ,Col_DVZ3,ObjPos_DVZ3,Level_DVZ3,Level_stub
	lhead	plcid_DVZ,Kos_DVZ,plcid_DVZ2,Blk16_DVZ,Blk256_DVZ3,0,palid_Black,Col_DVZ,ObjPos_DVZ4,Level_DVZ4,Level_DVZbg4
	...
	lhead	plcid_NGZ,Kos_NGZ,plcid_NGZ2,Blk16_NGZ,Blk256_NGZ,bgm_GHZ,palid_NGZ,Col_NGZ,ObjPos_NGZ3,Level_NGZ3,Level_NGZbg
	lhead	plcid_NGZ,Kos_NGZ,plcid_NGZ2,Blk16_NGZ,Blk256_NGZ,bgm_GHZ,palid_NGZ,Col_NGZ,ObjPos_NGZ1,Level_NGZ1,Level_NGZbg
	...
	lhead	plcid_BSZ,Kos_BSZ,plcid_BSZ2,Blk16_BSZ,Blk256_BSZ,bgm_BeforeBoss,palid_BSZ,Col_BSZ,ObjPos_BSZ1,Level_BSZ1,Level_BSZbg
