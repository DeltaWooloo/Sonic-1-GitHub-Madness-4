...
lhead:	macro plc1,lvlgfx,plc2,sixteen,twofivesix,music,pal,col1,objlay,lvllay,bglay
	...
	lhead	plcid_WIN,Kos_WIN,plcid_WIN,Blk16_WIN,Blk256_WIN,bgm_UNOwenWasHer,palid_WIN,Col_WIN,ObjPos_WIN1,Level_WIN1,Level_WINbg
	...
	lhead	plcid_Joint,Kos_Joint,plcid_Joint,Blk16_Joint,Blk256_Joint,bgm_FZ,palid_Joint,Col_Joint,ObjPos_Joint2,Level_Joint2,Level_Jointbg
