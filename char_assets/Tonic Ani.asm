...
ptr_Attack:	dc.w SonAni_Attack-Ani_Sonic
...
SonAni_Roll2:	dc.b $FE,  fr_Roll1,  fr_Roll2,  fr_Roll5,  fr_Roll3,  fr_Roll4,  fr_Roll5, afEnd
		even
SonAni_Push:	dc.b $FD,  fr_Push1,  fr_Push2,  fr_Push3,  fr_Push4, afBack, 2
		even
...
SonAni_Float4:	dc.b 3,	fr_Float1, afChange, id_Walk
		even
SonAni_Attack:	dc.b $B, fr_GetAir, afEnd 
		even
...
id_Attack:	equ (ptr_Attack-Ani_Sonic)/2	; $1E
