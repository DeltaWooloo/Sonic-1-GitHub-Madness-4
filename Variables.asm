...
;!@ GD: Vscroll bug water mark (arrow/text)
v_vsbmark_arrow	= v_objspace+object_size*16	; arrow
v_vsbmark_text	= v_objspace+object_size*17	; text
...
v_vdp_fx = v_unused1			; !@ GenesisDoes: Nu-huh. This is CLEARLY used for VDP FX from the Random Monitor.
