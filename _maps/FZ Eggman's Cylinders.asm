...
.flat:	spriteHeader
 spritePiece -$20, -$60-yfix, 4, 4, 0, 0, 0, 0, 0
 spritePiece -$20, -$40-yfix, 4, 4, $10, 0, 0, 0, 0
 spritePiece 0, -$60-yfix, 4, 4, $50, 0, 0, 0, 0
 spritePiece 0, -$40-yfix, 4, 4, $60, 0, 0, 0, 0
.flat_End

.extending1:	spriteHeader
 spritePiece -$20, -$60-yfix, 4, 4, 0, 0, 0, 0, 0
 spritePiece -$20, -$40-yfix, 4, 4, $10, 0, 0, 0, 0
 spritePiece -$20, -$20-yfix, 4, 4, $20, 0, 0, 0, 0
 spritePiece 0, -$60-yfix, 4, 4, $50, 0, 0, 0, 0
 spritePiece 0, -$40-yfix, 4, 4, $60, 0, 0, 0, 0
 spritePiece 0, -$20-yfix, 4, 4, $70, 0, 0, 0, 0
.extending1_End
...
.extending2:	spriteHeader
 ...
 spritePiece -$20, -$40-yfix, 4, 4, $10, 0, 0, 0, 0
 spritePiece -$20, -$20-yfix, 4, 4, $20, 0, 0, 0, 0
 spritePiece -$20, 0-yfix, 4, 4, $30, 0, 0, 0, 0
 spritePiece 0, -$60-yfix, 4, 4, $50, 0, 0, 0, 0
 spritePiece 0, -$40-yfix, 4, 4, $60, 0, 0, 0, 0
 spritePiece 0, -$20-yfix, 4, 4, $70, 0, 0, 0, 0
 spritePiece 0, 0-yfix, 4, 4, $80, 0, 0, 0, 0
.extending2_End
...
.extending3:	spriteHeader
 ...
 spritePiece -$20, -$20-yfix, 4, 4, $20, 0, 0, 0, 0
 spritePiece -$20, 0-yfix, 4, 4, $30, 0, 0, 0, 0
 spritePiece -$20, $20-yfix, 4, 4, $40, 0, 0, 0, 0
 spritePiece 0, -$60-yfix, 4, 4, $50, 0, 0, 0, 0
 spritePiece 0, -$40-yfix, 4, 4, $60, 0, 0, 0, 0
 spritePiece 0, -$20-yfix, 4, 4, $70, 0, 0, 0, 0
 spritePiece 0, 0-yfix, 4, 4, $80, 0, 0, 0, 0
 spritePiece 0, $20-yfix, 4, 4, $90, 0, 0, 0, 0
.extending3_End
...
.extendedfully:	spriteHeader
 ...
 spritePiece 0, 0-yfix, 4, 4, $80, 0, 0, 0, 0
 spritePiece 0, $20-yfix, 4, 4, $90, 0, 0, 0, 0
 spritePiece -$20, $3D-yfix, 4, 4, 0, 0, 1, 0, 1
 spritePiece 0, $3D-yfix, 4, 4, $50, 0, 1, 0, 1
.extendedfully_End
